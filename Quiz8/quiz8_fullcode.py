...
human_words = {id: word for id, word in id2word_wiki.items() if word.startswith("human")}

# Print the results
for word_id, word in human_words.items():
...
print([(id2word_wiki[id], value) for id, value in tfidf_vector])
########## QUESTION 2 CODE ###########
